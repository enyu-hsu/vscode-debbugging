...
1. Understanding what the model has learned by visualization approaches
    ...
    1. Visualizing conv layer filters by gradient ascending
        1. [Paper](http://yosinski.com/media/papers/Yosinski__2015__ICML_DL__Understanding_Neural_Networks_Through_Deep_Visualization__.pdf) and [blog](http://yosinski.com/deepvis) by author of the paper. (not the original inventor of this method)
    ...
    2. Visualizing activation of hidden layers
        ...
        Examples are show in Figure.4 from this [paper](https://www.cv-foundation.org/openaccess/content_iccv_2015/papers/Noh_Learning_Deconvolution_Network_ICCV_2015_paper.pdf).
